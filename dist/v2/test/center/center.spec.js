...
describe('post /centers', function () {
  ...
  it('should create event center', function (done) {
    _chai2.default.request(_index2.default).post('/v2/centers').send(_centers2.default.validCenter).end(function (err, res) {
  ...
  it('should generate a new id', function (done) {
    _chai2.default.request(_index2.default).post('/centers').send(_centers2.default.validCenter).end(function (err, res) {
      expect(res).to.have.status(200);
  ...
  it('should have a name', function (done) {
    _chai2.default.request(_index2.default).post('/centers').send(_centers2.default.centerWithoutName).end(function (err, res) {
  ...
  it('should have capacity', function (done) {
    _chai2.default.request(_index2.default).post('/centers').send(_centers2.default.noCapacity).end(function (err, res) {
      expect(res).to.have.status(406);
      expect(res.body).to.have.property('error').that.equal(true);
  ...
  it('should have capacity that is not zero', function (done) {
    _chai2.default.request(_index2.default).post('/centers').send(_centers2.default.zeroCapacity).end(function (err, res) {
      expect(res).to.have.status(406);
      expect(res.body).to.have.property('error').that.equal(true);
      expect(res.body).to.have.property('message').that.have.property('capacity');
      done();
  ...
  it('should have capacity that is only number', function (done) {
    _chai2.default.request(_index2.default).post('/centers').send(_centers2.default.invalidCapacity).end(function (err, res) {
      expect(res).to.have.status(406);
      expect(res.body).to.have.property('error').that.equal(true);
      expect(res.body).to.have.property('message').that.have.property('capacity');
      done();
  ...
  it('should have amount', function (done) {
    _chai2.default.request(_index2.default).post('/centers').send(_centers2.default.noAmount).end(function (err, res) {
      expect(res).to.have.status(406);
      expect(res.body).to.have.property('error').that.equal(true);
  ...
  it('should have amount that is only number', function (done) {
    _chai2.default.request(_index2.default).post('/centers').send(_centers2.default.invalidAmount).end(function (err, res) {
      expect(res).to.have.status(406);
      expect(res.body).to.have.property('error').that.equal(true);
      expect(res.body).to.have.property('message').that.have.property('amount');
      done();
