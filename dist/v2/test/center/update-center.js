...
describe('put /centers', function () {
	it('should update event center name', function (done) {
		var mfixture = _centers2.default.validCenter;
	...
	it('should not update without a name', function (done) {
		_chai2.default.request(_index2.default).put('/centers/2').send(_centers2.default.centerWithoutName).end(function (err, res) {
	...
	it('should not update without capacity', function (done) {
		_chai2.default.request(_index2.default).put('/centers/2').send(_centers2.default.noCapacity).end(function (err, res) {
			expect(res).to.have.status(406);
			expect(res.body).to.have.property('error').that.equal(true);
	...
	it('should not have capacity that is zero', function (done) {
		_chai2.default.request(_index2.default).put('/centers/2').send(_centers2.default.zeroCapacity).end(function (err, res) {
			expect(res).to.have.status(406);
			expect(res.body).to.have.property('error').that.equal(true);
			expect(res.body).to.have.property('message').that.have.property('capacity');
			done();
	...
	it('should have capacity that is only number', function (done) {
		_chai2.default.request(_index2.default).put('/centers/2').send(_centers2.default.invalidCapacity).end(function (err, res) {
			expect(res).to.have.status(406);
			expect(res.body).to.have.property('error').that.equal(true);
			expect(res.body).to.have.property('message').that.have.property('capacity');
			done();
	...
	it('should have amount', function (done) {
		_chai2.default.request(_index2.default).put('/centers/2').send(_centers2.default.noAmount).end(function (err, res) {
			expect(res).to.have.status(406);
			expect(res.body).to.have.property('error').that.equal(true);
	...
	it('should have amount that is only number', function (done) {
		_chai2.default.request(_index2.default).put('/centers/2').send(_centers2.default.invalidAmount).end(function (err, res) {
			expect(res).to.have.status(406);
			expect(res.body).to.have.property('error').that.equal(true);
			expect(res.body).to.have.property('message').that.have.property('amount');
			done();
