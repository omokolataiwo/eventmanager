...
var mEvent = _models2.default.events;
...
module.exports = {
  createEvent: function createEvent(req, res) {
    ...
    _models2.default.centers.findOne({
      ...
      _models2.default.events.findOne({
        where: {
          centerid: center.id,
        ...
        _models2.default.users.findOne({
          ...
          _models2.default.events.create(validatedEvent).then(function (newEvent) {
            if (!newEvent) {
  ...
  editEvent: function editEvent(req, res) {
    ...
    return _models2.default.events.findOne({ where: { id: req.params.id } }).then(function (event) {
      ...
      _models2.default.centers.findOne({ where: { id: req.body.centerid } }).then(function (center) {
        ...
        var validatedEvent = Object.assign(mEvent.toJSON(), { centerid: center.id });
